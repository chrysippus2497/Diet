...
$query=mysqli_query($con,"select sum(bal_value)  as today_bal from tb_bal where uid='$userid';");
$result=mysqli_fetch_array($query);
$total_bal = $result['today_bal'];


$query2=mysqli_query($con,"select sum(ExpenseCost) as total_expense from tblexpense where UserId='$userid';");
$result2=mysqli_fetch_array($query2);
$total_expense = $result2['total_expense'];


 ?> 
 						<div class="panel-body easypiechart-panel">
						<h4>Remaining Balance</h4>
						<div class="easypiechart" id="easypiechart-blue" data-percent="<?php echo $total_bal;?>" >
								<span class="percent">
									<?php if($total_bal==""){
									echo "0";
									} else {
									echo "₱ ". ($total_bal - $total_expense) ;
									}
			...
			<div class="col-xs-6 col-md-3">
				...
				<div class="panel panel-default">
					<div class="panel-body easypiechart-panel">
						<h4>Deposited Balance</h4>
						<div class="easypiechart" id="easypiechart-red" data-percent="<?php echo $total_bal;?>" ><span class="percent">
<?php if($total_bal==""){
echo "0";
} else {
echo "₱ ".$total_bal;

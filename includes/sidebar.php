...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        <div class="profile-sidebar">
            <div class="profile-userpic">
                <img src="https://icon2.cleanpng.com/20180626/ehy/kisspng-avatar-user-computer-icons-software-developer-5b327cc951ae22.8377289615300354013346.jpg" class="img-responsive" alt="">
            </div>
            ...
            <li class="parent "><a data-toggle="collapse" href="#sub-item-1">
                ...
                <ul class="children collapse" id="sub-item-1">
                    ...
                    <li><a class="" href="manage-expense.php">
                        <span class="fa fa-arrow-right">&nbsp;</span> Expenses Records
                    </a></li>
...
<li class="parent "><a data-toggle="collapse" href="#sub-item-3">
                <em class="fa fa-navicon">&nbsp;</em>Balance<span data-toggle="collapse" href="#sub-item-3" class="icon pull-right"><em class="fa fa-plus"></em></span>
                </a>
                <ul class="children collapse" id="sub-item-3">
                    <li><a class="" href="balance-balance.php">
                        <span class="fa fa-arrow-right">&nbsp;</span> Add Balance
                    </a></li>
                    <li><a class="" href="balance-records.php">
                        <span class="fa fa-arrow-right">&nbsp;</span> Balance Records
                    </a></li>
